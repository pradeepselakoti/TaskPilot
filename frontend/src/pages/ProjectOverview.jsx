    ...
    <div className="min-h-screen bg-gray-50 p-1 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-xl sm:text-3xl font-bold">E-Commerce Platform Redesign</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-white rounded-2xl shadow p-6">
            ...
            <p className="text-gray-600 mb-6">
              Complete redesign and modernization of our flagship e-commerce platform with focus on user experience and performance.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <ul className="space-y-4">
              {[
                { name: "Project Kickoff", date: "2024-01-15", status: "Completed", color: "green" },
                { name: "Design System", date: "2024-02-15", status: "Completed", color: "green" },
                { name: "Frontend MVP", date: "2024-03-30", status: "In progress", color: "indigo" },
                { name: "Backend Integration", date: "2024-04-30", status: "Pending", color: "gray" },
                { name: "User Testing", date: "2024-05-15", status: "Pending", color: "gray" },
                { name: "Production Deploy", date: "2024-06-30", status: "Pending", color: "gray" },
              ].map((item) => (
