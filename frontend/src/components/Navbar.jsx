      ...
      <div className="flex items-center gap-4">
        ...
        {shouldShowLogo && (
          <NavLink to={"/"} className="flex items-center gap-2 -ml-2">
            ...
            />
            <span className="font-semibold text-lg text-gray-800 md:text-3xl">
              TaskPilot
            </span>
          </NavLink>
        )}
      ...
      <div className="flex items-center gap-4 relative">
        <div className="relative">
          ...
          <NavLink to="/notification">
            <li className="flex items-center gap-2 px-3 py-3  rounded-4xl  bg-gray-100 hover:bg-gray-200 transition-colors duration-200 cursor-pointer">
              <FaBell size={19} />
            </li>
          </NavLink>
          {notificationCount > 0 && (
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden sm:block text-left">
              ...
              <p className="text-xs text-gray-500">COS Member</p>
            </div>
